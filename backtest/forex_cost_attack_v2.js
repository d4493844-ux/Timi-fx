...
async function main(){
  ...
  require("fs").writeFileSync("forex_attack_trades.json", JSON.stringify(allBestTrades,null,2));
  console.log(`\n💾 ${allBestTrades.length} trades (best config per pair) → forex_attack_trades.json`);
