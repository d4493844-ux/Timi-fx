...
SYMBOLS = [
    "BOOM1000", "CRASH1000", "R_25",
    "R_75", "R_50", "R_100",
    "frxEURUSD", "frxGBPUSD", "frxUSDJPY",
    "frxGBPJPY", "frxAUDUSD", "frxXAUUSD",
    "cryBTCUSD", "cryETHUSD"
]
...
def engineer_features(df):
    ...
    # MACD
    ema12 = df['ema8'].values  # approx
    ema26 = df['ema21'].values
...
def label_trades(df, lookahead=4):
    """Label each candle: 1=BUY wins, 0=SELL wins"""
...
async def main():
    ...
    print(f"\n✅ Done! Collected data for: {results}")
